    ...
    <div class="order-container" id="app">
        <div class="order-progress-bar">
            ...
            <div class="step done">
                ...
                <div class="bar"></div>
                <span class="step-text">10分钟内付款</span>
            </div>
            <div class="step last ">
                ...
                getData(process.env.baseUrl + '/order/getPayInfo', 'post', params).then((res) => {
                    ...
                    if (res) {
                        if (res.status == 0) {
                            ...
                            // console.log(res.data.qRCodeAddress)
                             _this.qrcodeImg = res.imgPre + res.data.QRCodeAddress;

                           // var  pic1 = res.data.qRCodeAddress.split('pic')
                           // var  pic1 = res.data.qRCodeAddress
                            //console.log(pic1)
                           // _this.qrcodeImg = '/pic' + pic1[pic1.length -1] ;

                            var repetition = setInterval(()=>{
                                _this.tryNums++;
                                if (_this.tryNums > 3){
