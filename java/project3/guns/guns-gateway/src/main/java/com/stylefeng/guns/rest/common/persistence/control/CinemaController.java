...
public class CinemaController {
    ...
    public Result getFields(Integer cinemaId){
        ...
        if (map.get("cinemaInfo")==null) return new Result(1,"影院信息查询失败!");
    ...
    public Result getFieldInfo(Integer cinemaId,Integer fieldId){
        String soldSeats1 = orderService.getOrderSeats(fieldId);
        FieldInfo fieldInfo = cinemaService.getFieldInfo(cinemaId,fieldId,soldSeats1);
