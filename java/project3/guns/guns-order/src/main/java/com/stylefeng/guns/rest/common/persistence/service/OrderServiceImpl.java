...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderRespVo buyTickets(OrderReqVo orderReqVo, String seat_address, Integer userId, OrderField orderField, String filmName,String cinemaName) {
        ...
        String seats = getSeats(orderReqVo.getSoldSeats());
        orderT.setSeatsIds(seats);
    ...
    private String getSeats(List<Integer> soldSeats) {
        StringBuffer stringBuffer = new StringBuffer();
        if (!CollectionUtils.isEmpty(soldSeats)){
    ...
    public List<OrderRespVo> getOrderInfo(Integer userId, Integer nowPage, Integer pageSize) {
        ...
        for (MoocOrderT orderT : orderTS) {
            ...
            respVo.setOrderPrice(String.valueOf(orderT.getOrderPrice()));
            respVo.setOrderTimestamp(StringTool.date2StringBeHmS(orderT.getOrderTime()));
    ...
    @Override
    public Integer updateOrderByorderId(String orderId, Integer payResult) {
        Integer i = orderTMapper.updateOrder_statusById(orderId,payResult);
        return i;
    }

    @Override
    public String getOrderSeats(Integer fieldId) {
        List<String> seats = orderTMapper.selectSeats_idsByField_id(fieldId);
