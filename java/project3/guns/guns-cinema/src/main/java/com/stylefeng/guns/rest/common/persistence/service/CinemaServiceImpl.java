...
public class CinemaServiceImpl implements CinemaService {
    ...
    @Override
    public FieldInfo getFieldInfo(Integer cinemaId, Integer fieldId,String soldSeats) {
        ...
        if (fieldT!=null){
            ...
            //String soldSeats = orderService.getOrderSeats(fieldId);
            hallInfo.setSoldSeats(soldSeats);
            //hallInfo.setSoldSeats("");
    ...
    @Override
    public PromoRespVo queryPromoCinemaVoBycinemaId(Integer cinemaId) {
        MtimeCinemaT mtimeCinemaT = cinemaTMapper.selectMtimeCinemaTById(cinemaId);
        PromoRespVo respVo = new PromoRespVo();
        if (mtimeCinemaT!=null){
            respVo.setCinemaAddress(mtimeCinemaT.getCinemaAddress());
            respVo.setCinemaName(mtimeCinemaT.getCinemaName());
            respVo.setImgAddress(mtimeCinemaT.getImgAddress());
        }
        return respVo;
    }
}
