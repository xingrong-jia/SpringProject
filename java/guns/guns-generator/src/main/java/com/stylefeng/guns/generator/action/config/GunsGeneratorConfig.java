...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        globalConfig.setOutputDir("D:\\RedisProject\\guns\\guns-api\\src\\main\\java");//写自己项目的绝对路径,注意具体到java目录
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setPassword("jxr0406");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/guns_rest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convert_To_Null&serverTimezone=GMT%2B8");
    }
    ...
    protected void contextConfig() {
        ...
        contextConfig.setProjectPath("D:\\RedisProject\\guns");//写自己项目的绝对路径
